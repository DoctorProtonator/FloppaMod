...
public class ModEntityGeneration
{
	...
	{
        addEntityToSavanna(event, EntityInit.BIG_FLOPPA.get(), 75, 4, 8);
    }
    ...
    private static void addEntityToSavanna(BiomeLoadingEvent event, EntityType<?> type, int weight, int minCount, int maxCount)
    {
